...
echo "Installerer crm-platform-integration ver. 0.112"
call sf package install --package 04t7U000000Y4QNQA0 --no-prompt --installation-key %3 --wait 30 --publish-wait 30
